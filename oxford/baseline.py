...
training = pd.read_csv(path_to_data + 'Removed0001_0002/training_set_Removed0001_startsFrom2001-07.csv', sep=',', header=0)

training_info = pd.read_csv(path_to_data + 'Removed0001_0002/training_info_Removed0001_startsFrom2001-07.csv', sep=',', header=0)
...
with open(path_to_results + 'predictions_frequency_2001_07.txt', 'wb') as my_file:
    my_file.write('mid,recipients' + '\n')
    for sender, preds in predictions_per_sender.iteritems():
        ids = preds[0]
        freq_preds = preds[2]
